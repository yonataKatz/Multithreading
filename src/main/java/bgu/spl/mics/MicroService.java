...
public abstract class MicroService implements Runnable {
    ...
    protected ConcurrentHashMap<Class,Callback> callBackMap = new ConcurrentHashMap<>();
    ...
    public final void run() {
        ...
        mb.register(this);
        initialize();
        // at this point after initialize - the microService is registered to MB and to EVENTS + BROADCASTS
        while (!terminated) {
            try {
